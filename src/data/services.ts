...
export const SERVICES: ServiceInfo[] = [
  {
    ...
    faq: [
      ...
      {
        question: "부당해고 구제신청 비용은 얼마나 드나요?",
        answer: "사안의 난이도에 따라 다르며, 초기 상담을 통해 예상 비용을 안내해 드립니다.",
      },
      {
        question: "회사가 권고사직을 강요하는데 이것도 부당해고인가요?",
        answer:
          "본인의 자유로운 의사에 반해 사직을 강요당했다면 실질적으로 해고로 인정될 수 있습니다.",
      },
      {
        question: "해고예고수당은 별도로 받을 수 있나요?",
        answer: "30일 전 해고 예고를 하지 않은 경우 해고예고수당을 별도로 청구할 수 있습니다.",
      },
    ],
  },
  {
    ...
    faq: [
      ...
      {
        question: "포괄임금제라서 연장수당을 못 받는다고 하는데 맞나요?",
        answer:
          "포괄임금제라도 실제 연장근로 시간에 비해 수당이 부족하면 차액을 청구할 수 있습니다.",
      },
      {
        question: "임금체불로 형사고소도 가능한가요?",
        answer:
          "임금체불은 근로기준법 위반으로 형사처벌 대상이 되며, 진정과 별도로 고소도 가능합니다.",
      },
      {
        question: "프리랜서인데도 임금체불 진정이 가능한가요?",
        answer:
          "계약 형식과 무관하게 실질적으로 근로자성이 인정되면 임금체불 진정이 가능합니다.",
      },
    ],
  },
  {
    ...
    faq: [
      ...
      {
        question: "가해자가 대표님인데도 신고할 수 있나요?",
        answer:
          "가해자의 지위와 관계없이 신고 및 조치 요구가 가능하며, 필요한 경우 고용노동부에 직접 진정할 수 있습니다.",
      },
      {
        question: "괴롭힘으로 퇴사했는데 실업급여를 받을 수 있나요?",
        answer:
          "직장 내 괴롭힘으로 인한 퇴사는 비자발적 이직으로 인정되어 실업급여 수급이 가능할 수 있습니다.",
      },
      {
        question: "조사 결과에 불복하면 어떻게 해야 하나요?",
        answer:
          "회사의 조치가 미흡하다고 판단되면 고용노동부 진정이나 민사상 손해배상 청구를 검토할 수 있습니다.",
      },
    ],
  },
  {
    ...
    faq: [
      ...
      {
        question: "산재 신청을 회사가 거부하면 어떻게 하나요?",
        answer: "회사 동의 없이도 근로자가 직접 근로복지공단에 산재를 신청할 수 있습니다.",
      },
      {
        question: "산재 처리 중에도 회사에서 해고할 수 있나요?",
        answer: "산재 요양 기간과 그 후 30일간은 원칙적으로 해고가 제한됩니다.",
      },
      {
        question: "산재로 후유장해가 남으면 어떤 보상을 받나요?",
        answer:
          "장해등급에 따라 장해급여를 청구할 수 있으며, 등급 산정에 대한 이의도 제기할 수 있습니다.",
      },
    ],
  },
  {
    ...
    faq: [
      ...
      {
        question: "노동위원회 심문은 어떤 방식으로 진행되나요?",
        answer:
          "근로자와 사용자 양측의 진술과 증거 제출을 거쳐 공익위원 등이 판정을 내리는 방식으로 진행됩니다.",
      },
      {
        question: "화해나 조정으로도 끝낼 수 있나요?",
        answer: "심문 전후로 화해·조정 절차를 통해 합의로 사건을 종결할 수도 있습니다.",
      },
      {
        question: "노동위원회 결정에는 강제력이 있나요?",
        answer:
          "확정된 구제명령은 법적 구속력이 있으며, 불이행 시 이행강제금이 부과될 수 있습니다.",
      },
    ],
  },
];
